...
public class WaveSystemEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            levelManager.enemyWaves.Add(new EnemyWave(60f));
        }
        for (int i = 0; i < levelManager.enemyWaves.Count; i++)
        {
            EnemyWave wave = levelManager.enemyWaves[i];
            ...
            {
                levelManager.enemyWaves.RemoveAt(i);
                i--;
            }
            EditorGUILayout.EndVertical();
        }
